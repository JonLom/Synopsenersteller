...
- A PDF containing the amendment proposal. Provided by user in web interface.
...
- Identify relevant pages for the amendment. There can be mulitple pages of prosa before the actual amendment.
